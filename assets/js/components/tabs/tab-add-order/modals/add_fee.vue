...
<script>
	...
	export default {
		...
		methods: {
			apply() {
                            this.$store.commit('add_order/addFeeItem', {name: this.elFeeName, type: this.elFeeType, amount: this.elFeeAmount, original_amount: this.elFeeAmount, add_manually: true});
                            this.close();
			},
			shown( e ) {

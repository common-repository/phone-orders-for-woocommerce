<template>
    <div class="product-item-meta-field-list-item">
        ...
        <div v-show="editable" class="product-item-meta-field-list-item-edit">
            <input type="text" v-model.trim.lazy="input_meta_key" :disabled="!cartEnabled" :placeholder="customMetaKeyPlaceholder">
            <span class="product-item-meta-field-list-item-edit__equal">=</span>
            <input type="text" v-model.trim.lazy="input_meta_value" :disabled="!cartEnabled" :placeholder="customMetaValuePlaceholder">
            <a href="#" @click.prevent="cartEnabled ? deleteMeta(index) : null" :class="{disabled: !cartEnabled}" class="meta-delete-btn">
                &times;
            </a>
        </div>

		...
		<slot name="edit-customer-address-modal-header" modal="editAddressModal"></slot>
			...
			></custom-autocomplete>
				...
				<span>
                                    ...
                                    <strong><label :for="loopField.key" class="mr-sm-2" :class="[ emptyRequiredFieldsList.indexOf(loopField.key) > -1 ? 'text-danger' : '' ]">{{ requiredFieldsList.indexOf(loopField.key) > -1 ? loopField.label + ' *' : loopField.label }}</label></strong>

        ...
        >
            ...
            <div v-else-if="filteredProductList.length > 0" class="wpo-product-history-list-wrapper">
                <div class="wpo-product-history-list" :class="{'wpo-grid': displayAsGrid}">
                    <div v-for="product in filteredProductList" class="wpo-product-history-list__product" @click="selectedProductList[product.product_id]['checked'] = !selectedProductList[product.product_id]['checked']">
                        <span class="wpo-product-history-list__product__item" @click="isAllowConfigureProduct && useConfigureProductActionAsDefault ? configureProduct(product) : null">
                            ...
                            <img class="wpo-product-history-list__product__item__image" :src="product.img" alt="" v-show="!!product.img"
                                 width="100">
                            <span class="wpo-product-history-list__product__item__desc">
                                <span v-if="defaultActionClickOnTitle === 'edit_product'">
                                    <a :href="product.product_link" target="_blank" @mousedown.stop @click.stop>
                                        <span class="wpo-product-history-list__product__item__desc__title" v-html="product.title"></span>
                                    </a>
                                </span>
                            ...
                            <span class="wpo-product-history-list__product__item__input-price" v-if="isShowPriceInput" @click.stop>
                                <b-form-input size="sm" autocomplete="off" placeholder="0" v-model="selectedProductList[product.product_id]['item_cost']" v-bind:disabled="!cartEnabled" @mousedown="selectedProductList[product.product_id]['checked'] = true" class="price" @input="selectedProductList[product.product_id]['cost_updated_manually'] = true"></b-form-input>
                            </span>
                            <span class="wpo-product-history-list__product__item__input-qty" v-if="isShowQtyInput" @click.stop>
                                <b-form-input
                                    size="sm"
                                    type="number"
                            ...
                            <button class="btn btn-light wpo-btn-configure-product" @click="configureProduct(product)" v-show="isAllowConfigureProduct && !useConfigureProductActionAsDefault">

...
class WC_Phone_Orders_Tools_Page extends WC_Phone_Orders_Admin_Abstract_Page {
	...
	public function render() {
		...
		$this->tab_data = array(
                    ...
                    'noteLabel'   => __('If you have problems with the plugin, you should submit a <a href="https://algolplus.freshdesk.com/support/tickets/new" target="_blank">new support request</a> and attach the generated report to it.', 'phone-orders-for-woocommerce'),
                );
